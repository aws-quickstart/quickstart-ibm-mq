...
If the license file is in place at stack creation time, the IBM MQ server will automatically use the production license. To upgrade from a trial license to a production license after deployment, follow the instructions in the https://www.ibm.com/support/knowledgecenter/SSFKSJ_9.2.0/com.ibm.mq.ins.doc/q008943_.htm[IBM Knowledge Center].
